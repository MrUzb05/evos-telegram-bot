...
class Database:
    ...
    def product_delivery(self, tg_id):
        text = '''Telefon raqamingizni quyidagi formatda yuboring yoki kiriting: +998 ** *** ** **
        Eslatma: Agar siz onlayn buyurtmangiz uchun Click yoki Payme orqali toʻlashni rejalashtirmoqchi boʻlsangiz, 
        tegishli xizmatda hisob qaydnomangiz roʻyxatdan oʻtgan telefon raqamini koʻrsating.'''
